...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
jhu.edu:user:full_radio_Liao:1.0\
...
proc create_root_design { parentCell } {
  ...
  set axi_str_rxd_tready_0 [ create_bd_port -dir O axi_str_rxd_tready_0 ]
  set axi_str_rxd_tlast_0 [ create_bd_port -dir I axi_str_rxd_tlast_0 ]

  # Create instance: full_radio_0, and set properties
  set full_radio_0 [ create_bd_cell -type ip -vlnv jhu.edu:user:full_radio_Liao:1.0 full_radio_0 ]
...
connect_bd_intf_net -intf_net full_radio_0_m_axis [get_bd_intf_pins full_radio_0/m_axis] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M00_AXI] [get_bd_intf_pins full_radio_0/S00_AXI] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  ...
  [get_bd_ports axi_str_rxd_tready_0]
